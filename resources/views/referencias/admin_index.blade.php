    ...
    <div class="tabla-admin-container">
        <div class="flex flex-col items-center justify-center mb-8">
            <div class="flex items-center gap-3">
                <span class="inline-flex items-center justify-center rounded-full bg-[#009fe3] p-3 shadow">
                    <svg class="h-7 w-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 17v-2a4 4 0 014-4h2a4 4 0 014 4v2M7 7a4 4 0 118 0 4 4 0 01-8 0zM3 21h18" />
                    </svg>
                </span>
                <h2 class="text-3xl font-extrabold text-[#002c5f] tracking-tight">Referencias por Departamento</h2>
            </div>
            <p class="mt-2 text-base text-gray-600 text-center max-w-xl">
                Visualiza, filtra y gestiona las referencias administrativas por departamento.
            </p>
        </div>
        ...
        <form method="GET" action="{{ route('referencias.admin') }}" class="tabla-admin-filtros" style="width:100%;">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                ...
                <select name="departamento"
                    class="block w-full md:w-32 pl-3 pr-6 py-2 text-base border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#007bff] focus:border-[#007bff] sm:text-sm rounded-md">
                ...
                <table class="min-w-full w-[1400px] max-w-none divide-y divide-gray-200" style="overflow-y: hidden;">
                    ...
                    <thead class="bg-gradient-to-r from-[#002c5f] to-[#004a9f] text-white">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-bold uppercase tracking-wider sticky-col-2">
                                Correlativo</th>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-bold uppercase tracking-wider">Fecha de Generación
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-bold uppercase tracking-wider">Última Modificación
                            </th>
                        ...
                        @forelse ($referencias as $i => $ref)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-800 max-w-xs truncate"
                                    title="{{ nombreDepartamento($ref->departamento) }}">
                            ...
                            <tr>
                                <td colspan="11" class="px-6 py-12 text-center text-gray-500">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="mt-2 text-sm font-medium text-gray-900">No hay referencias registradas
                                        </h3>
