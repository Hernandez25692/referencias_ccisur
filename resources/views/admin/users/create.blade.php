    ...
    <div class="min-h-screen flex items-center justify-center bg-[#0c1c3c] py-8 px-4">
        <div class="backdrop-blur-lg bg-white/10 max-w-3xl w-full mx-auto mt-8 rounded-xl shadow-xl p-6 md:p-10">
            <div class="flex items-center gap-3 justify-center mb-8">
                <i class="ph ph-user-plus text-[#b79a37] text-4xl"></i>
                <h2 class="text-3xl md:text-4xl font-extrabold text-white tracking-tight">Crear Usuario</h2>
            </div>
            <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="password" class="block text-sm font-semibold text-white mb-1">Contraseña</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-semibold text-white mb-1">Confirmar Contraseña</label>
                        <div class="relative">
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4">
                    ...
                    <button type="submit"
                        ...
                        <i class="ph ph-floppy-disk text-base mr-2"></i> Guardar
                    </button>
                </div>
            </form>
        </div>
